...
export default function DeclineCareRequestModal({
  open,
  submitting,
  onCancel,
  onConfirm,
  ...
  return (
    ...
    >
      ...
      >
        ...
        <h3 className="font-display text-lg font-bold mb-2 text-center">Decline this request?</h3>
        <p className="text-[13.5px] text-ink/65 leading-relaxed mb-5 text-center">
          We&apos;ll let the requester know by email, so please keep this respectful and clear.
        </p>
        ...
        <TextAreaField
          ...
          placeholder="e.g. We're not currently taking on new clients in this area."
        />
        ...
        <div className="flex gap-2.5 mt-5">
          ...
          <Button
            fullWidth
            className="bg-brick! hover:bg-brick-deep!"
