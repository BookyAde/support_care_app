  ...
  return (
    <div style={{ perspective: "900px" }}>
      <div
        ...
        className={`relative bg-paper-raised border border-black/10 rounded-2xl transition-[transform,border-color,box-shadow] duration-150 hover:border-teal hover:shadow-lg overflow-hidden group ${className}`}
